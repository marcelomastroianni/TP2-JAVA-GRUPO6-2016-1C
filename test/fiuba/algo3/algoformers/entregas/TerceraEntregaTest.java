...
public class TerceraEntregaTest {
	...
	public void test01() throws InvalidPositionException, AlgoformerUsadoEsteTurnoException, AlgoformerAtrapadoEsteTurnoException {
		...
		algoformer1.notifyNextTurn( board );
	...
	public void test04() throws InvalidPositionException, AlgoformerUsadoEsteTurnoException, AlgoformerAtrapadoEsteTurnoException {
		...
		frenzy.notifyNextTurn( board );						//Le quedan 2 turnos de DobleDamage
		...
		frenzy.notifyNextTurn( board );						//Le quedan 1 turnos de DobleDamage y 3 de Flash
		frenzy.shot(optimus,board);
		frenzy.notifyNextTurn( board );						//Se quedo sin turnos de DobleDamage y 2 de Flash
		...
		frenzy.notifyNextTurn( board );						//Le quedan 3 turnos de DobleDamage y 1 de Flash
		...
		optimus.notifyNextTurn( board );
		frenzy.shot(optimus,board);
		frenzy.notifyNextTurn( board );						//Se quedo sin turnos de Flash y 2 de DobleDamage
		...
		frenzy.notifyNextTurn( board );						//Le quedan 1 turnos de DobleDamage
