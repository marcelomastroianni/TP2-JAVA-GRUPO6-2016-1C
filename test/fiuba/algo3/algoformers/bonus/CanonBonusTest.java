...
public class CanonBonusTest {
	...
	public void createCanonBonus(){	
		CanonBonus canonBonus = new CanonBonus(new Position(0,0));
	...
	public void testCapturarCanonBonus() throws JugadorNoPuedeUtilizarAlgoformerQueNoEsSuyoException, UsuarioNoSeleccionoAlgoformerException, JugadorNoPuedeJugarCuandoNoEsSuTurnoException{
		...
		Assert.assertEquals("El poder de ataquer de bumblebee deberia ser 50", new Integer(50), algofomerJugador1.getActiveMode().getAttack());
		...
		Assert.assertEquals("El poder de ataquer de bumblebee deberia ser 100", new Integer(100), algofomerJugador1.getActiveMode().getAttack());
	}
