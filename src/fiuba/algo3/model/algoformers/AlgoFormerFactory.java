...
public class AlgoFormerFactory {
	...
	public static Algoformer getOptimusPrime(Position position) {
		...
		return new Algoformer("Optimus Prime", humanoidMode,alternalMode,500,position);
	}
	...
	public static Algoformer getBumblebee(Position position) {
		...
		return new Algoformer("Bumblebee", humanoidMode,alternalMode,350,position);
	}
	...
	public static Algoformer getRatchet(Position position) {
		...
		return new Algoformer("Ratchet", humanoidMode,alternalMode,150,position);
	}
	
	public static Algoformer getSuperion(Position position) {
		Mode humanoidMode = new ModeHumanoid(100,2,3);
		return new Algoformer("Superion", humanoidMode,humanoidMode,100,position);
	}
	...
	public static Algoformer getMegatron(Position position) {
		...
		return new Algoformer("Megatron", humanoidMode,alternalMode,550,position);
	}
	...
	public static Algoformer getBonecrusher(Position position) {
		...
		return new Algoformer("Bonecrusher", humanoidMode,alternalMode,200,position);
	}
	...
	public static Algoformer getFrenzy(Position position) {
		...
		return new Algoformer("Frenzy", humanoidMode,alternalMode,400,position);
	}
	
	public static Algoformer getMenasor(Position position) {
		Mode humanoidMode = new ModeHumanoid(115,2,2);	
		return new Algoformer("Menasor", humanoidMode,humanoidMode,400,position);
	}
